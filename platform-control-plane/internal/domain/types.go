...
type EnvironmentRequest struct {
	...
	GitPromotionMode        string            `json:"git_promotion_mode,omitempty"`
	GitPromotionBranch      string            `json:"git_promotion_branch,omitempty"`
	GitPromotionURL         string            `json:"git_promotion_url,omitempty"`
	...
	EstimatedMonthlyCostUSD int               `json:"estimated_monthly_cost_usd,omitempty"`
}
